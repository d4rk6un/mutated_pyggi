# Mutated PYGGI (Python General Framework for Genetic Improvement) 

<p align="center">
  <img alt="PYGGI logo" src="/images/mutated_pyggi_logo.png" />
</p>

Mutated PYGGI는 KAIST Search-Based Software Engineering 강의 과제 제출용으로 작성되었습니다.  

#### xml tree operator 추가 구현
* VariableReplacement : function parameter variable replacement
* CmpOperReplacement :  comparison operator replacement


## [original PyGGI 2.0](https://github.com/coinse/pyggi)
# Original PyGGI README.md
