...
from pyggi.tree import StmtReplacement, StmtInsertion, StmtDeletion, VariableReplacement, CmpOperReplacement
...
if __name__ == "__main__":
    ...
    if args.mode == 'line':
        ...
        tabu_search = MyTabuSearch(program)
        tabu_search.operators = [StmtReplacement, StmtInsertion, StmtDeletion, VariableReplacement, CmpOperReplacement]
