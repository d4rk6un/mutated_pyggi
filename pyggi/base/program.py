...
class AbstractEngine(ABC):
    ...
    @classmethod
    @abstractmethod
    def get_variables(cls, contents_of_file):
        pass
...
class AbstractProgram(ABC):
    ...
    def load_contents(self):
        ...
        for file_name in self.target_files:
            ...
            #ADD
            self.variables[file_name] = engine.get_function_variables(self.contents[file_name])
    ...
    def exec_cmd(self, cmd, timeout=15, path=None):
        cwd = os.getcwd()
        #ADD : Edited for new srcml file bug
        if path == None:
